package com.sc.wxfood.util.json;
...
public class JsonUtilWx {
    ...
    public static void main(String[] args) {
        ...
        String interfaceJson = JsonUtilWx.getNode(str, "interface");
        String resultJson = JsonUtilWx.getNode(interfaceJson, "returnStateInfo");
        String dataJson = JsonUtilWx.getNode(interfaceJson, "Data");
        System.out.println(dataJson);
        Map<String, String> map = JsonUtilWx.toMap(dataJson);
